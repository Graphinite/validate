...
describe('Test the validations functions', () => {
  describe('validateCreateObjects()', () => {
    ...
    test('should succeed', () => {
      ...
      const run5 = () => validateCreateObjects([{ tag: 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx' }]);

      expect(run1).not.toThrow();
      expect(run2).not.toThrow();
      expect(run3).not.toThrow();
      expect(run4).not.toThrow();
      expect(run5).not.toThrow();
    });
  });
